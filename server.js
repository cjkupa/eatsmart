...
app.get('/api/places', async (req, res) => {
  ...
  const keyword = cuisine && cuisine !== 'Any' ? '&keyword=' + encodeURIComponent(cuisine) : '';
  const url = 'https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=' + lat + ',' + lng + '&radius=' + (radius || 2000) + '&type=restaurant' + keyword + '&key=' + GOOGLE_API_KEY;
  try {
