        ...
        <div style={S.card}>
          ...
          <div style={S.row}>
            <div style={{flex:1,position:"relative"}}>
              <div style={{fontSize:11,fontWeight:600,color:"#aaa",marginBottom:3,textAlign:"left"}}>CITY</div>
              <input
            ...
            <div style={{flex:1,position:"relative"}}>
              <div style={{fontSize:11,fontWeight:600,color:"#aaa",marginBottom:3,textAlign:"left"}}>SUBURB / STREET</div>
              <input
                style={{width:"100%",border:"1.5px solid #ede8e3",borderRadius:14,padding:"11px 14px",fontSize:15,fontFamily:"inherit",outline:"none",boxSizing:"border-box",background:"#fff",color:"#222",textAlign:"left"}}
